...
func gracefulStop(signals chan os.Signal) {
	...
	log.Info("Got signal SIGTERM, shutting down...")
	...
	log.Info(fmt.Sprintf("Still alive after %v, going to force kill the process...", delayTimeBeforeForceQuit))
